...
void apply_blessing(void)            { printf("Update! (apply_blessing stub)\n"); }
void apply_curse(void)               { printf("Update! (apply_curse stub)\n"); }
void random_blessing_or_curse(void)  { printf("Update! (random_blessing_or_curse stub)\n"); }
void apply_neutral_effect(void)      { printf("Update! (apply_neutral_effect stub)\n"); }
void apply_chaotic_effect(void)      { printf("Update! (apply_chaotic_effect stub)\n"); }
void random_curse(void)              { printf("Update! (random_curse stub)\n"); }
void random_blessing(void)           { printf("Update! (random_blessing stub)\n"); }

void define_user_ritual(const char *name, const char *g1, const char *g2, const char *outcome, const char *effect_code)
{
    (void)name;
    (void)g1;
    (void)g2;
    ...
    printf("Update! (define_user_ritual stub)\n");
}

void define_ritual(const char *name, const char *code, int aeon, int elemental) {
    (void)elemental;  // TODO: integrate with elemental_synergy
